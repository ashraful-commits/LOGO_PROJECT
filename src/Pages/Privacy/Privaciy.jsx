<>
  ...
  <ul>
    ...
    <li>
      <p>
        <strong>Application</strong> refers to Logo, the software program
    ...
    <li>
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to Logo.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Logo, accessible from{" "}
        <a
          href="https://logo-project-assignment.vercel.app"
          rel="external nofollow noopener"
          target="blank"
        >
          https://logo-project-assignment.vercel.app
        </a>
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>By email: ashrafulalam10000@gmail.com</li>
  </ul>
</>;
